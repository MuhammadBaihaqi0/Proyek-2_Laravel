                ...
                <div
                    ...
                    <div class="p-8 md:flex items-center justify-between relative z-10">
                        ...
                        <div class="hidden md:block text-right max-w-xs opacity-90 border-l border-white/20 pl-6">
                            <p class="italic text-sm">"Success is a final, failure is not fatal: it is the courage to
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fade-in delay-200">
                    ...
                    <div
                        ...
                        <div class="p-6 bg-gray-50 border-b border-gray-100 flex justify-between items-center">
                            ...
                            <span class="text-xs font-semibold bg-emerald-100 text-emerald-700 px-2 py-1 rounded">Total:
                                {{ count($acara) }}</span>
                        </div>
                                ...
                                @forelse($acara as $a)
                                    <div
                                        ...
                                        <form action="{{ route('acara.destroy', $a->id) }}" method="POST"
                                            onsubmit="return confirm('Hapus acara ini?')" class="flex-shrink-0 ml-2">
                                            @csrf @method('DELETE')
                                            <button type="submit"
                                ...
                                <ul class="space-y-2 max-h-[200px] overflow-y-auto no-scrollbar">
                                    @forelse($riwayat_tugas as $rt)
                                        <li
                                            ...
                                            <span
                                                class="text-[10px] bg-green-100 text-green-700 px-2 py-0.5 rounded-full font-bold">DONE</span>
                                        </li>
                                    @empty
                                ...
                                <ul class="space-y-2 max-h-[200px] overflow-y-auto no-scrollbar">
                                    @forelse($riwayat_acara as $ra)
                                        <li
                                            ...
                                            <span
                                                class="text-xs text-gray-400">{{ \Carbon\Carbon::parse($ra->tanggal)->format('d M Y') }}</span>
                                        </li>
                                    @empty
